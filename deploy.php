...
define('DEPLOY_TOKEN', 'aerofind_secure_deploy_2026');
...
if (isset($_GET['simulate']) || !empty($_SESSION['simulate_update'])) {
    ...
    flush(); ob_flush(); usleep(400000);
    echo "<h3>[Success] Simulation Deployment successful! Your site is fully updated to v1.8.5.</h3>";
    exit;
}
